      ...
      async function renderBoards() {
        ...
        for (const b of boards) {
          ...
          editBtn.onclick = () => openBoardModal(b);
        ...
        createBtn.onclick = () => openBoardModal(null);
      ...
      function openBoardModal(board) {
        ...
        title.textContent = isNew ? "New board" : board.name;
        ...
        // re-tags the whole board (for object types whose content goes stale).
        const at = {
        ...
        // Per-board tagger override — key registry is fetched async; the
        // selects stay disabled until it arrives.
        const aiWrap = document.getElementById("board-modal-ai");
        const aiKeySel = document.createElement("select");
