...
Not started: the stock type (steps 5–6) and the refresh loop (step 7). Sections below are updated where a shipped piece changed the design (marked ✅). **The refactor phase (steps 1–4) is complete — the next commit can be the stock adapter itself.**
